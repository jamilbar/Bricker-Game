...
public class ExtraPaddle extends Paddle {
    /* a counter to count the collision between the main ball and the paddle*/
    private Counter ballPaddleCollisionCounter;
    /* an instance of GameObjectCollection game, to add and remove objects*/
    private  GameObjectCollection gameObjects;

    /**
     * the param extraPaddle represents whether there is an extra paddle in the curren frame of the
     * game
     */
